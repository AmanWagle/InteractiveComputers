                ...
                <tbody>
                  ...
                  >
                    ...
                    <td width="10%">
                      <img
                        height="70px"
                        :src="`/storage/images/uploads/${product_category.icon}`"
                      />
                    </td>
                    <td width="20%">
                    ...
                    <td width="15%">
                      ...
                      >
                      <span
                        v-if="product_category.is_featured"
                    ...
                    <td width="10%">
                      <div class="form-check-glow form-switch">
                        <input
                          ...
                          v-model="product_category.is_featured"
                          @change="toogleStatusOrFeatured(product_category)"
                        />
                      </div>
                    </td>
                    <td width="15%">
                      ...
                      <button
                        @click="deleteProductCategary(product_category)"
