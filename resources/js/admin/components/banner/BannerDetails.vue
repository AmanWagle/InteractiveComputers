            ...
            <div class="row">
              <div class="col-12 form-group">
                ...
                <div class="col-sm-10">
                  ...
                  >
                    <i class="bi bi-cloud-arrow-up-fill"></i>&nbsp; Upload Image
                  </button>
                  <input
                    ref="imageInput"
                    type="file"
              ...
              <div class="col-12">
                <div class="mt-2 form-group">
                  <div class="form-check-glow form-switch">
                    ...
                    />&nbsp;&nbsp;&nbsp;
                    <label class="form-check-label" for="image-status"
                      >Status</label
                    >
                  </div>
                </div>
            ...
            <div class="col-12">
              <div class="mt-4 form-group">
                <div class="form-check-glow form-switch">
                  ...
                  />&nbsp;&nbsp;&nbsp;
                  <label class="form-check-label" for="banner-status"
                    >Status</label
                  >
                </div>
              </div>
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table table-striped text-center mb-0">
                ...
                <tbody>
                  <tr
                    v-for="(image, index) in this.banner.banner_images"
                    :key="image.id"
                  >
                    <td>{{ index + 1 }}</td>
                    <td>
                      <img
                        height="70px"
                        :src="`/storage/images/uploads/${image.name}`"
                      />
                    </td>
                    <td>
                    ...
                    <td>
                      <button
                        @click="onBannerImageDelete(image)"
  ...
  methods: {
    ...
    async onBannerImageSubmit() {
      try {
        ...
        if (response.data.success) {
          this.banner_images.image= "";
          this.banner_images.link= "";
          this.status="true";
          this.image_preview="";
