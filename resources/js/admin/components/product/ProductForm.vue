                    ...
                    >
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div
                                    class="form-group col-md-2 my-2 d-flex align-items-center"
                                >
                                    <div
                                        class="form-switch form-check-glow d-flex"
                                    >
                                        <input
                        ...
                        <div class="card-body">
                            <div class="col-md-12 form-group">
                                ...
                                <label
                                    ...
                                    class="text-muted"
                                >
                                    *Existing images will be replaced if you
                                    choose to upload new images.
                                </label>
                ...
                <div class="card col-12 shadow">
                  ...
                  "
                                >
                                    <span>
                                        <i
                                            class="fas fa-arrow-right fa-2x text-primary"
                                        ></i>
                                    </span>
                                </div>
